...
**A1** 
The most common sanction is summary suspension and surrender of license, both mentioned 7 times.
```{r}
...
**A3**
I think seeing what words come up most frequently would be helpful for determining where Van Hollen wants his public facing agenda to be at. We can also compare it to the work he's actually doing (what laws he's sponsored/how he votes) to determine the authenticity of his press team. You could also use all the press releases to determine what name appears most frequently in his releases, making a shortlist of key allies he has.
```{r}
cvh_url <- "https://www.vanhollen.senate.gov/news/press-releases"

cvh_html <- cvh_url |> 
  read_html() |> 
  html_elements('div.ArticleBlock__titleContainer')
...
cvh_results <- bind_cols(cvh_date, cvh_title, cvh_url)
```
