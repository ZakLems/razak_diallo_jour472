...
The columns are the same as the list of 2 from the previous code block and they could be put in lowercase, have dates in the proper format, and do without the spaces.
```{r}
...
Maybe an excerpt from the press release would be helpful to have.
```{r}
...
There are 94 <li> tags. By modifying the code block I was able to find 7 ul tags meaning there are 7 different lists on the page.
```{r}
osp_results |> html_elements('ul')
```
...
The output shows the text of the list items
```{r}
...
The output shows all the text of all 94 list items, including menus.
```{r}
